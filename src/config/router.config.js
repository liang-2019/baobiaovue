...
export const constantRouterMap = [
  ...
  },
  {
    ...
    component: RouteView,
    meta: {title: '展示'},
    redirect: '/system/CnMaintainLsRecordListByTwo',
    children: [
      {
        path: 'cncc',
        name: 'cncc',
        component: () => import('@/views/system/CnMaintainLsRecordListByTwo')
      },
    ]
  },
  {
    ...
    component: RouteView,
    meta: {title: '展示'},
    redirect: '/system/CnMaintainRecordListByTwo',
    children: [
      {
        path: 'cnbb',
        name: 'cnbb',
        component: () => import('@/views/system/CnMaintainRecordListByTwo')
      },
    ]
  },
  // {
