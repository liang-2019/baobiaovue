...
<script>
  ...
  export default {
    name: 'CnMaintainLsRecordListByTwo',
    ...
    data () {
      return {
        ...
        url: {
          list: "/system/cnMaintainLs/SHlistTHree",
          delete: "/system/cnMaintainLs/delete",
          deleteBatch: "/system/cnMaintainLs/deleteBatch",
          exportXlsUrl: "/system/cnMaintainLs/exportXls",
          importExcelUrl: "system/cnMaintainLs/importExcel",
    ...
    methods: {
      ...
      getList(){
        getAction(this.url.list, {
          ...
          this.dataSource = res.result.cnMaintainLsResultVo;
